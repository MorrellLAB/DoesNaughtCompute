...
An unordered, mutable collection of primitive types 

tuple 

An unordered, unmutable collection of primitive types 

set 

An unordered, mutable, unique collection of primitive types 

dict 

An unordered, mutable collection of primitive types stored in key: value 
pairs 
...
#symmetric difference (elements that are in the first set and the 
